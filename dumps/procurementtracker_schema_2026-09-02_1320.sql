...
) ENGINE=InnoDB AUTO_INCREMENT=70076 DEFAULT CHARSET=armscii8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `notifications` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=164 DEFAULT CHARSET=armscii8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `transid` (
  ...
  `archive` tinyint(1) DEFAULT NULL,
  UNIQUE KEY `product_id_UNIQUE` (`product_id`)
) ENGINE=InnoDB AUTO_INCREMENT=52 DEFAULT CHARSET=armscii8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-09-02 13:20:02
