...
--
-- Dumping data for table `market_scoping_results`
--

LOCK TABLES `market_scoping_results` WRITE;
/*!40000 ALTER TABLE `market_scoping_results` DISABLE KEYS */;
/*!40000 ALTER TABLE `market_scoping_results` ENABLE KEYS */;
UNLOCK TABLES;
