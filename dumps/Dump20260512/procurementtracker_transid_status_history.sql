...
--
-- Dumping data for table `transid_status_history`
--

LOCK TABLES `transid_status_history` WRITE;
/*!40000 ALTER TABLE `transid_status_history` DISABLE KEYS */;
/*!40000 ALTER TABLE `transid_status_history` ENABLE KEYS */;
UNLOCK TABLES;
