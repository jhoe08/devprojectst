...
) ENGINE=InnoDB AUTO_INCREMENT=70156 DEFAULT CHARSET=armscii8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `notifications` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=174 DEFAULT CHARSET=armscii8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `transid` (
  ...
  `archive` tinyint(1) DEFAULT NULL,
  UNIQUE KEY `product_id_UNIQUE` (`product_id`)
) ENGINE=InnoDB AUTO_INCREMENT=54 DEFAULT CHARSET=armscii8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-09-11  9:04:32
