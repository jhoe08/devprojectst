...
) ENGINE=InnoDB AUTO_INCREMENT=70012 DEFAULT CHARSET=armscii8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `notifications` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=60 DEFAULT CHARSET=armscii8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-05-13  9:04:32
