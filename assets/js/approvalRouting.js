export const smallValueMessages = {
    ...
    3: {
        ...
        responsible: {
            section: 'GS',
            tasks: {
                svp: ['pr_numbering', 'budget_allocated', 'canvass_preparation', 'signing_canvass'],
                public: ['pr_numbering', 'notation']
            }
        }
    },
    4: {
    ...
    15: {
        ...
        } // Accounting -> additional input ORS numbering
    },
    16: {
        initial: {
...
export const publicBiddingMessages = {
    1: {
        initial: {
            ...
            text: "Click 'Confirm' to submit the Bid Proposal for processing.",
        },
        confirmed: {
            title: "Proposal Submitted",
            text: "The Bid Proposal has been successfully submitted.",
        },
        denied: {
            title: "Submission Denied",
            text: "The Bid Proposal was not submitted by the End-User.",
        },
        confirmedDenied: {
            title: "Denial Recorded",
            text: "The End-User's denial has been successfully recorded.",
    ...
    2: {
        initial: {
            title: "Confirm Approval",
            text: "Please click 'Confirm' to approve this Bid Proposal and continue to the next step.",
        },
        confirmed: {
            title: "Approval Confirmed",
            text: "The Bid Proposal has been successfully forwarded to the next approver.",
        },
        denied: {
            title: "Approval Denied",
            text: "The Bid Proposal was not approved by the Division Chief.",
        },
        confirmedDenied: {
            title: "Denial Recorded",
            text: "The Division Chief's denial has been successfully recorded.",
    ...
    3: {
        ...
        denied: {
            title: "Funds Not Approved",
            text: "The Budget Office has denied the availability of funds for this proposal. Click 'Confirm' to complete the process.",
        },
        confirmedDenied: {
            title: "Denial Recorded",
            text: "The denial of funds availability has been successfully recorded.",
    ...
    5: {
        ...
        denied: {
            title: "Review Denied",
            text: "BAC Secretariat did not approve the proposal.",
        },
        confirmedDenied: {
            title: "Denial Recorded",
            text: "BAC Secretariat's denial has been successfully recorded.",
    ...
    6: {
        initial: {
            title: "Prepare Invitation to Bid",
            text: "Click 'Confirm' to proceed with invitation to bid preparation.",
        },
        confirmed: {
            title: "Invitation Prepared",
            text: "Invitation to Bid has been successfully prepared.",
        },
        denied: {
            title: "Preparation Denied",
            text: "Invitation to Bid preparation was not approved.",
        },
        confirmedDenied: {
            title: "Denial Recorded",
            text: "Denial of invitation to bid preparation has been recorded.",
        }
    },
    7: {
        initial: {
            title: "Advertise Bidding Opportunity",
            text: "Click 'Confirm' to begin the advertisement process.",
        },
        confirmed: {
            title: "Advertisement Started",
            text: "Bidding opportunity has been successfully advertised.",
        },
        denied: {
            title: "Advertisement Denied",
            text: "Advertisement was not approved.",
        },
        confirmedDenied: {
            title: "Denial Recorded",
            text: "Advertisement denial has been successfully recorded.",
        }
    },
    8: {
        initial: {
            title: "Conduct Pre-bid Conference",
            text: "Click 'Confirm' to proceed with pre-bid conference.",
        },
        confirmed: {
            title: "Conference Conducted",
            text: "Pre-bid conference has been successfully conducted.",
        },
        denied: {
            title: "Conference Denied",
            text: "Pre-bid conference was not approved.",
        },
        confirmedDenied: {
            title: "Denial Recorded",
            text: "Pre-bid conference denial has been recorded.",
        }
    },
    9: {
        initial: {
            title: "Open and Evaluate Bids",
            text: "Click 'Confirm' to complete BAC evaluation.",
        },
        confirmed: {
            title: "Evaluation Complete",
    ...
    10: {
        initial: {
            title: "Post-qualify Bidders",
            text: "Click 'Confirm' to finalize post-qualification.",
        },
        confirmed: {
            title: "Qualification Finalized",
            text: "Post-qualification has been finalized.",
        },
        denied: {
            title: "Qualification Denied",
            text: "Post-qualification was not approved.",
        },
        confirmedDenied: {
            title: "Denial Recorded",
            text: "Post-qualification denial has been recorded.",
        }
    },
    11: {
        initial: {
    ...
    12: {
        ...
        confirmed: {
            title: "Notice Prepared",
            text: "The Notice of Award has been successfully prepared.",
        },
        denied: {
            title: "Preparation Denied",
            text: "Notice of Award preparation was not approved.",
        },
        confirmedDenied: {
            title: "Denial Recorded",
            text: "Notice of Award preparation denial has been recorded.",
        }
    },
    13: {
        initial: {
            title: "Prepare Contract",
            text: "Click 'Confirm' to prepare the Contract.",
        },
        confirmed: {
            title: "Contract Prepared",
            text: "The Contract has been successfully prepared.",
        },
        denied: {
            title: "Preparation Denied",
            text: "Contract preparation was not approved.",
        },
        confirmedDenied: {
            title: "Denial Recorded",
            text: "Contract preparation denial has been recorded.",
        }
    },
    14: {
        initial: {
            title: "Final Review",
            text: "Click 'Confirm' to complete the final review of the proposal.",
        },
        confirmed: {
            title: "Review Completed",
            text: "Final review has been successfully completed.",
...
export function initApprovalRouting() {
    ...
    $(document).on("click", ".alert_confirm", function (e) {
        ...
        showConfirmationAlert({
            title: messageSet[currentStep].initial.title,
            text: messageSet[currentStep].initial.text,
            requestUrl: "/approve",
            requestMethod: "POST",
            requestData: {
                ...
                remarks: messageSet[currentStep].confirmed.text
            },
            successTitle: messageSet[currentStep].confirmed.title,
            successText: messageSet[currentStep].confirmed.text,
        })
    })
    ...
    $(document).on("click", ".alert_deny", function (e) {
        ...
        const currentStep = $(this).data('step')
        showConfirmationAlert({
            title: messageSet[currentStep].denied.title,
            text: messageSet[currentStep].denied.text,
            ...
            requestData: {
                ...
                product_id: productId,
                steps_number: currentStep,
                remarks: messageSet[currentStep].confirmedDenied.text,
            },
            successTitle: messageSet[currentStep].confirmedDenied.title,
            successText: messageSet[currentStep].confirmedDenied.text,
        })
    })
}
